...
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://petclinic-helm-charts-james/stable/myapp/ || echo "repository name already exists"
AWS_REGION=$AWS_REGION helm repo update
helm package k8s/petclinic_chart
AWS_REGION=$AWS_REGION helm s3 push --force petclinic_chart-0.0.1.tgz stable-petclinic
...
AWS_REGION=$AWS_REGION helm upgrade --install \
    petclinic-app-release stable-petclinic/petclinic_chart --version 0.0.1 \
